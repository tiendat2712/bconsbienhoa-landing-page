  ...
  const cards = isEn
    ? [
        ...
        },
        {
          ...
          desc: 'Detailed unit plans from 43 to 86 sqm.',
          href: '/mat-bang',
        },
        {
          kind: t.related.kind,
          title: 'Internal Amenities',
          desc: '7,700+ sqm park, infinity pool, and shophouses.',
          href: '/tien-ich',
        },
        {
          kind: t.related.kind,
          title: 'Legal Compliance',
          desc: 'Long-term freehold, 1/500 detailed plan, construction permits.',
          href: '/phap-ly',
        },
      ]
    : [
