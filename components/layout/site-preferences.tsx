...
const copy = {
  vi: {
    ...
    hero: {
      ...
      formDesc: 'Để lại số điện thoại, Giám đốc Sàn sẽ liên hệ trong vòng 15 phút.',
      phone: 'Số điện thoại',
    ...
    news: {
      ...
      posts: [
        {
          title: 'Có gì bên trong căn hộ chỉ từ 49.9 triệu/m2 của Bcons tại Biên Hòa?',
          date: '10/09/2026',
          tag: 'Nhà mẫu & Giá bán',
          source: 'Báo Tiền Phong',
          summary: 'Từ ngày 11/09/2026, nhà mẫu Bcons Central Park chính thức trình làng tại số 236 Phan Trung, thu hút hàng trăm lượt khách đăng ký tham quan thực tế không gian sống xanh, tối ưu công năng ngay giữa lòng đô thị Biên Hòa.',
          image: '/images/news/news-tienphong.avif',
          url: 'https://tienphong.vn/co-gi-ben-trong-can-ho-chi-tu-499-trieum2-cua-bcons-tai-bien-hoa-post1875159.tpo',
        },
        {
          title: 'Dự án đầu tiên của Bcons tại TP. Đồng Nai sắp khai trương nhà mẫu',
          date: '10/09/2026',
          tag: 'Sự kiện & Khai trương',
          source: 'Báo Đầu Tư',
          summary: 'Khai trương nhà mẫu Bcons Central Park mang đến góc nhìn chân thật về chuẩn sống xanh được thiết kế tối ưu công năng, đón nhận sự quan tâm đặc biệt của đông đảo khách hàng an cư và nhà đầu tư.',
          image: '/images/news/news-baodautu.jpg',
          url: 'https://baodautu.vn/du-an-dau-tien-cua-bcons-tai-tp-dong-nai-sap-khai-truong-nha-mau-d697715.html',
        },
        {
          title: 'Một tập đoàn công bố lộ trình dự án bất động sản hơn 4.400 tỉ tại Đồng Nai',
          date: '17/08/2026',
          tag: 'Quy mô & Đầu tư',
          source: 'Kinh Tế Mới 24h',
          summary: 'Tập đoàn Bcons vừa công bố lộ trình triển khai dự án Bcons Central Park - khu nhà ở phức hợp cao tầng tại phường Tam Hiệp với tổng vốn đầu tư gần 4.400 tỉ đồng, đón đầu chu kỳ phát triển mới.',
          image: '/images/news/news-kinhtemoi.jpeg',
          url: 'https://www.kinhtemoi24h.net/mot-tap-doan-cong-bo-lo-trinh-du-an-bat-dong-san-hon-4400-ti-tai-dong-nai-222380.html',
        },
        {
    ...
    contact: {
      ...
      formDesc: 'Giám đốc Sàn sẽ liên hệ lại trong vòng 15 phút.',
      name: 'Họ và tên',
      ...
      successDesc: 'Cảm ơn quý khách đã quan tâm. Giám đốc Sàn Lê Ngọc Long sẽ liên hệ lại trong vòng 15 phút.',
      ...
      consultantBadge: 'Giám đốc Sàn Kinh Doanh Bcons PS Land',
      consultantName: 'Lê Ngọc Long',
      consultantRole: 'Giám đốc Sàn Kinh Doanh Bcons PS Land',
      ...
      scanQrDesc: 'Kết nối nhanh với Giám đốc Sàn Lê Ngọc Long',
    ...
    footer: {
      consultantIntro:
        'Tôi là Lê Ngọc Long, Giám đốc Sàn Kinh Doanh Bcons PS Land. Đây là trang tôi biên soạn về dự án Bcons Central Park Tam Hiệp — còn được gọi là Bcons Tam Hiệp, Bcons Phan Trung, Bcons Biên Hòa.',
  ...
  en: {
    ...
    hero: {
      ...
      formDesc: 'Leave your phone number, our Sales Director will contact you within 15 minutes.',
      phone: 'Phone number',
    ...
    news: {
      ...
      posts: [
        {
          title: "What's inside Bcons's high-rise condos from 49.9 million VND/sqm in Bien Hoa?",
          date: '10/09/2026',
          tag: 'Show Unit & Pricing',
          source: 'Tien Phong Newspaper',
          summary: 'From Sep 11, 2026, the Bcons Central Park show gallery officially opens at 236 Phan Trung, welcoming hundreds of prospective buyers to experience authentic green living and functional layout optimization.',
          image: '/images/news/news-tienphong.avif',
          url: 'https://tienphong.vn/co-gi-ben-trong-can-ho-chi-tu-499-trieum2-cua-bcons-tai-bien-hoa-post1875159.tpo',
        },
        {
          title: "Bcons's debut project in Dong Nai set to unveil official show unit gallery",
          date: '10/09/2026',
          tag: 'Events & Launch',
          source: 'Vietnam Investment Review',
          summary: 'The grand opening of Bcons Central Park model homes offers prospective residents a tangible, real-world preview of eco-friendly architecture and optimized living spaces in central Bien Hoa.',
          image: '/images/news/news-baodautu.jpg',
          url: 'https://baodautu.vn/du-an-dau-tien-cua-bcons-tai-tp-dong-nai-sap-khai-truong-nha-mau-d697715.html',
        },
        {
          title: 'Leading conglomerate unveils roadmap for 4,400 billion VND real estate complex in Dong Nai',
          date: '17/08/2026',
          tag: 'Investment & Scale',
          source: 'Kinh Te Moi 24h',
          summary: 'Bcons Group announces comprehensive execution roadmap for Bcons Central Park in Tam Hiep with total investment capital near 4,400 billion VND, addressing strong regional housing demand.',
          image: '/images/news/news-kinhtemoi.jpeg',
          url: 'https://www.kinhtemoi24h.net/mot-tap-doan-cong-bo-lo-trinh-du-an-bat-dong-san-hon-4400-ti-tai-dong-nai-222380.html',
        },
        {
    ...
    contact: {
      ...
      formDesc: 'Our Sales Director will reach out within 15 minutes.',
      name: 'Full Name',
      ...
      successDesc: 'Thank you for your interest. Sales Director Le Ngoc Long will contact you within 15 minutes.',
      sendAnother: 'Send another request',
      privacyNote: 'Your information is strictly protected and used solely for Bcons Central Park consultation.',
      consultantBadge: 'Sales Director – Bcons PS Land',
      consultantName: 'Le Ngoc Long',
      consultantRole: 'Sales Director at Bcons PS Land',
      ...
      scanQrDesc: 'Connect instantly with Sales Director Le Ngoc Long',
    ...
    footer: {
      consultantIntro:
        'I am Le Ngoc Long, Sales Director at Bcons PS Land. This page is dedicated to Bcons Central Park Tam Hiep — also known as Bcons Tam Hiep, Bcons Phan Trung, Bcons Bien Hoa.',
